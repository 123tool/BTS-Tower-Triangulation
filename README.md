...
**Tim investigasi biasanya mendapatkan data log dari operator seluler yang berisi daftar koordinat tower (BTS) yang sempat terhubung dengan HP target. Dengan data tersebut, kita bisa melakukan Triangulasi untuk mempersempit area keberadaan target. Simulasi pemetaan lokasinya menggunakan library Folium.**
...
2. git clone : `https://github.com/123tool/BTS-Tower-Triangulation.git`
3. cd `BTS-Tower-Triangulation`
4. Jalankan script: `python Triangulation.py`
5. Buka file `spy_e_map.html` di browser laptop Anda.
